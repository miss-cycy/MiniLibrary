                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-3">
                                        ...
                                        @if($borrow->status === 'borrowed' || $borrow->status === 'partially_returned')
                                            <form action="{{ route('borrows.return', $borrow) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="p-2 bg-green-50 rounded-lg border border-green-200 text-green-600 hover:bg-green-100 transition-colors" title="Return Books">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
